---
title: "Bài 0: Làm quen với Anaconda"
---
...
Ở đây, **_-n_** là viết tắt của **_-name_**, **_zootopi_** là tên của môi trường. Các bạn có thể đổi tên môi trường tuỳ vào mục đích của môi trường, tạo cho dự án nào, lưu ý là tên môi trường phải viết liền không dấu. Để chọn phiên bản Python, ta sử dụng **_python=_**. Hiện nay, Python đã có hỗ trợ đến phiên bản 3.12+. Tuy nhiên, để đảm bảo tính ổn định và tương thích với các thư viện phổ biến, mình khuyến khích các bạn sử dụng Python 3.10 hoặc Python 3.11 (Python 3.7 và 3.8 đã không còn được hỗ trợ chính thức).
...
- **Conda, Miniconda, Anaconda**:
  - `Conda`: Công cụ quản lý môi trường và gói
  - `Miniconda = Python + conda`
  - `Anaconda = Python + conda + gói meta anaconda` (160+ gói Python)
- **Tạo môi trường ảo**: `conda create -n tên_môi_trường python=3.x`
...
Trong bài viết tiếp theo, ZootoPi sẽ tiếp tục giới thiệu đến các bạn về `JupyterLab` và `Jupyter Notebook`. Vậy 2 khái niệm này là gì? Sử dụng `JupyterLab` và `Jupyter Notebook` như thế nào để có thể làm việc hiệu quả? Hãy tiếp tục với [Bài 0: Jupyter](./02.jupyter.md)!
