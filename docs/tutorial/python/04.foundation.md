...
- [ ] Sử dụng các cấu trúc cơ bản trong Python (biến, kiểu dữ liệu, cấu trúc điều khiển) 
...
Ok, bây giờ chúng ta sẽ cùng nhau tìm hiểu sâu hơn về các thành phần cơ bản trong Python nha.
