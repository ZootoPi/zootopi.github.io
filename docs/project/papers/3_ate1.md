...
Kết quả thử nghiệm được trình bày trong bảng dưới đây. Phương pháp của chúng ta có hiệu suất nhất quán với tất cả các cách kết hợp lĩnh vực khác nhau. Mô hình hoạt động tốt hơn một chút trong việc trích xuất các thuật ngữ từ lĩnh vực Ngôn ngữ học và Thú y hơn là từ Cơ sinh học và Hóa học. Hơn thế nữa, cách tiếp cận của chúng ta vượt trội hơn so với hình đương thời áp dụng trên cùng tập dữ liệu.
